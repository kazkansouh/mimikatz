...
KUHL_M_SEKURLSA_PACKAGE kuhl_m_sekurlsa_credman_package = {"credman", kuhl_m_sekurlsa_enum_logon_callback_credman, TRUE, "lsasrv.dll", {{{NULL, NULL}, 0, 0, NULL}, FALSE, FALSE}};
