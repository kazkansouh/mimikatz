...
KUHL_M_SEKURLSA_PACKAGE kuhl_m_sekurlsa_livessp_package = {"livessp", kuhl_m_sekurlsa_enum_logon_callback_livessp, FALSE, "livessp.dll", {{{NULL, NULL}, 0, 0, NULL}, FALSE, FALSE}};
