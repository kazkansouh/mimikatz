...
KUHL_M_SEKURLSA_PACKAGE kuhl_m_sekurlsa_wdigest_package = {"wdigest", kuhl_m_sekurlsa_enum_logon_callback_wdigest, TRUE, "wdigest.dll", {{{NULL, NULL}, 0, 0, NULL}, FALSE, FALSE}};
